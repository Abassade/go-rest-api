...
import (
	...
	. "github.com/abassade/user-api/config"
	. "github.com/abassade/user-api/dao"
	. "github.com/abassade/user-api/models"
)
...
func Home(w http.ResponseWriter, r *http.Request){
	respondWithJson(w, http.StatusOK,
		map[string]string{"error": "false", "message": "API is healthy"})
}
...
func main() {
	...
	fmt.Println("API is listening on port 3000")
